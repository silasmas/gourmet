...
Route::get('/admin/{entity}/{id}', [HomeController::class, 'dashboardEntity'])->name('dashboard.entity.datas');
Route::post('/admin/{entity}/{id}', [HomeController::class, 'dashboardEntity']);
