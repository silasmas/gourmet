...
Route::get('/admin/{entity}/{id}', [HomeController::class, 'dashboardEntityDatas'])->whereNumber('id')->name('dashboard.entity.datas');
Route::post('/admin/{entity}/{id}', [HomeController::class, 'updateDashboardEntity'])->whereNumber('id');
