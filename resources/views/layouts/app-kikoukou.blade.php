...
@if (Route::is('menu'))
        <style>
            .mCard {width: 100%;flex-direction: column; overflow: hidden; border-radius: 1.5rem;} .mCard-body {flex: 1 1 auto; padding: 1rem;} .mCard-img {width: 100%;}
        </style>
@endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 d-flex">
                                ...
                                <div class="div">
                                    <h6>Réservations</h6>
                                    <p>
                                        <span>Phone: <a href="tel:+243898681751"> (+243) 898 681 751</a> / <a href="tel:+243833344116">833 344 116</span>
                                    </p>
                                    <p>
